...
func TestClickHouse_UpdateOptions(t *testing.T) {
	...
	assert.True(t, reflect.DeepEqual(clickHouseExporter.chExportProcess.GetClickHouseConfig(), chConfig))
	...
	assert.True(t, reflect.DeepEqual(clickHouseExporter.chExportProcess.GetClickHouseConfig(), newChConfig))
