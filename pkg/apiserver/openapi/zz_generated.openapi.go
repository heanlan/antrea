		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"associatedGroups": {
						SchemaProps: spec.SchemaProps{
							Description: "AssociatedGroups is a list of GroupReferences that is associated with the IP address being queried.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_controlplane_v1beta2_SupportBundleCollection(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "SupportBundleCollection is the message format of antrea/pkg/controller/types.SupportBundleCollection in an API response.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_controlplane_v1beta2_SupportBundleCollectionList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "SupportBundleCollectionList is a list of SupportBundleCollection objects.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_controlplane_v1beta2_SupportBundleCollectionNodeStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "SupportBundleCollectionNodeStatus is the status of a SupportBundleCollection on a Node.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"nodeName": {
						SchemaProps: spec.SchemaProps{
					...
					"nodeNamespace": {
						SchemaProps: spec.SchemaProps{
							Description: "The namespace of the Node that produces the status. It is set only when NodeType is ExternalNode.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"nodeType": {
						SchemaProps: spec.SchemaProps{
							Description: "The type of the Node that produces the status. The values include Node and ExternalNode.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"completed": {
						SchemaProps: spec.SchemaProps{
							Description: "The phase in which a SupportBundleCollection is on the Node.",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
...
func schema_pkg_apis_controlplane_v1beta2_SupportBundleCollectionStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "SupportBundleCollectionStatus is the status of a SupportBundleCollection.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
